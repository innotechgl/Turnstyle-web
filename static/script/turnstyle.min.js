...
var HomePost = (function (_React$Component) {
  _inherits(HomePost, _React$Component);

  function HomePost() {
    _classCallCheck(this, HomePost);

    _get(Object.getPrototypeOf(HomePost.prototype), "constructor", this).apply(this, arguments);
  }

  _createClass(HomePost, [{
    key: "render",
    value: function render() {
      return _react2["default"].createElement("div", { className: "small-6 columns columns--reset offer-item", "data-item": "Lorem Ipsum", "data-price": "25", "data-owner": "Usman54" }, _react2["default"].createElement("div", { className: "item-image" }, _react2["default"].createElement("a", { className: "btn--action", href: "/offer/test" }, _react2["default"].createElement("img", { src: "https://placeholdit.imgix.net/~text?txtsize=29&txt=314%C3%97314&w=314&h=314" }))), _react2["default"].createElement("div", { className: "item-context text-center" }, _react2["default"].createElement("div", { className: "offers-section offer-underline description", "data-type": "description" }, _react2["default"].createElement("h6", { className: "title small" }, "Lorem Ipsum"), _react2["default"].createElement("h6", { className: "subtitle tiny" }, "by Usman54")), _react2["default"].createElement("span", { className: "pricing", "data-type": "price", "data-price": "25" }, "$25")));
    }
  }]);
...
var _homePost = require('./home-post');

var _homePost2 = _interopRequireDefault(_homePost);

var HomePosts = (function (_React$Component) {
  _inherits(HomePosts, _React$Component);

  function HomePosts() {
    _classCallCheck(this, HomePosts);

    _get(Object.getPrototypeOf(HomePosts.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(HomePosts, [{
    key: 'render',
    value: function render() {
      var posts = _.map(_.range(0, 10), function (n, i) {
        return _react2['default'].createElement(_homePost2['default'], null);
      });

      var postsChunked = _.map(_.chunk(posts, 2), function (posts, i) {
        return _react2['default'].createElement('div', { className: 'row' }, posts);
      });

      return _react2['default'].createElement('div', null, postsChunked);
    }
  }]);
...
},{"./home-post":157,"react":156}],159:[function(require,module,exports){
'use strict';
...
var _utilsWhichTransitionEvent = require('../utils/which-transition-event');

var _utilsWhichTransitionEvent2 = _interopRequireDefault(_utilsWhichTransitionEvent);

var _utilsWhichAnimationEvent = require('../utils/which-animation-event');

var _utilsWhichAnimationEvent2 = _interopRequireDefault(_utilsWhichAnimationEvent);

var transitionEvent = (0, _utilsWhichTransitionEvent2['default'])();
var animationEvent = (0, _utilsWhichAnimationEvent2['default'])();
...
$(document).ready(function () {
  ...
  var $loginUser = $('a.login-user');
  var $buttonAuthUser = $('a.btn-auth-user');
  ...
  $loginUser.on('click', function (e) {
    e.preventDefault();
    var _id = $(this).data('reveal-id');
    //log(_id);
    $('#' + _id).foundation('reveal', 'open');
  });

  // links within the modal
  $('#modal-login a[data-selector]').on('click', function (e) {
    var $this = $(this);

    if ($this.data('selector') !== '') {
      $('#modal-login .form-section').removeClass('active');
  ...
  $(document).on('closed.fndtn.reveal', '[data-reveal]', function () {
    $('#modal-login .form-section').removeClass('active');
    $('#modal-login .form-section').first().addClass('active');
  });

  //
  // modal slide
  //
  //$('.slide-modal').css({'top':'0px'});
  $('.slide-modal').css({ 'top': '-100%' });
  $('body').append('<div class="slide-modal-bg" style="display: none;"></div>');
  $('a[data-slide-id], .close-slide-modal').on('click', function (e) {
    var $this = $(this);
    var $target = $('#' + $this.data('slide-id'));
    var show = $target.hasClass('on');

    if (!show) {
      $target.addClass('on');
      $target.animate({ 'top': '0px' }, 'slow', function () {
        $('.slide-modal-bg').toggle();
      });
    } else {
      $('.slide-modal-bg').toggle();
      $target.animate({ 'top': '-100%' }, 'slow', function () {
        $target.removeClass('on');
      });
    }
  });

  $('#nav').on('toggled', function (event, accordion) {
    console.log(accordion);
  });

  $buttonAuthUser.click(function (e) {
    e.preventDefault();
    var $this = $(e.currentTarget);
    var url = $this.data('url');
    var selector = $this.data('selector');
    var type = $this.data('auth-type');
  ...
  // mock paging
  //
  if ($main.hasClass('template-offers')) {
    $('.button-delete').click(function (e) {
      var $this, $offer, isDelete;
      $this = $(this);
      $offer = $('#offer-' + $this.data('delete-id'));
      //console.log($offer);

      isDelete = confirm("Delete this Offer?");
      if (isDelete) {
        $offer.addClass('animated fadeOutRight');
        $offer.one(animationEvent, function (event) {
          $offer.remove();
        });
      }
    });
  ...
  if ($main.hasClass('template-profile')) {}
});

//
// SEARCH BAR
//
$('#home-search-x').click(function (e) {
  $('#top-search-bar').hide();
});

$('#search-trigger').click(function (e) {
  var elem = $('#top-search-bar');
...
},{"../utils/which-animation-event":167,"../utils/which-transition-event":168}],160:[function(require,module,exports){
'use strict';
...
// FORGOT PASSWORD
//
var forgotValidator = new FormValidator('passwordreset', [{
  name: 'e',
  display: 'Email',
  rules: 'required|valid_email'
}], function (errors, event) {
  (0, _utilsLog2['default'])(errors);
  event.preventDefault();

  // reset
  var $g = $('#' + event.target.id + ' .control-group');
  for (var i = 0; i < $g.length; i++) {
    var $el = $($g[i]).find('small');
    if (!$el.hasClass('none')) {
      $el.addClass('none');
    }
  }
  ...
  if (errors.length > 0) {
    ...
    for (var k = 0; k < errors.length; k++) {
      var $input = $(errors[k].element);
      var $err = $input.parent().find('small');
    ...
    $.ajax({
      ...
      success: function success(response, textStatus, xhr) {
        (0, _utilsLog2['default'])(response);
        if (xhr.status == 200 && response.success) {
          var go = confirm('A password reset was sent to your email!');
          if (go) {
...
},{"../utils/log":166}],161:[function(require,module,exports){
'use strict';
...
var _componentsHomePosts = require('../components/home-posts');

var _componentsHomePosts2 = _interopRequireDefault(_componentsHomePosts);

if ($('#main-wrapper').hasClass('template-home')) {
  React.render(React.createElement(_componentsHomePosts2['default'], null), document.getElementById('offers-list'));
}

exports['default'] = {};
module.exports = exports['default'];

},{"../components/home-posts":158}],162:[function(require,module,exports){
'use strict';
...
// LOGIN
//
var loginValidator = new FormValidator('userlogin', [{
  name: 'e',
  display: 'Email',
  rules: 'required|valid_email'
}, {
...
},{"../utils/log":166}],163:[function(require,module,exports){
'use strict';
...
// PROFILE FORM
//
var profileValidator = new FormValidator('userprofile', [{
    name: 'profile_name',
    ...
    if (errors.length > 0) {
        ...
        /*
        const $me = $(`#${event.target.id}`);
        const  str = $me.serialize();
        $.ajax({
                url: $me.attr('action'),
                type: $me.attr('method'),
                dataType: 'json',
...
profileValidator.registerCallback('check_select', function (value) {
    if (value == "") {
        return false;
    }
    return true;
}).setMessage('check_select', 'Please choose one option.');

exports['default'] = {};
module.exports = exports['default'];

},{"../utils/log":166}],164:[function(require,module,exports){
'use strict';
...
// SIGNUP
//
var signupValidator = new FormValidator('usersignup', [{
  name: 'u',
  display: 'Full Name',
  rules: 'required'
}, {
  ...
  rules: 'required|matches[p]'
}, {
  name: 's',
  display: 'Enter Paypal Email'
}], function (errors, event) {
  (0, _utilsLog2['default'])(errors);
  event.preventDefault();
...
},{"../utils/log":166}],165:[function(require,module,exports){
"use strict";
...
// Cross Browser Console/Logs
// http://www.paulirish.com/2009/log-a-lightweight-wrapper-for-consolelog/
// Prevent errors if a console isn’t around (i.e. IE), etc
Object.defineProperty(exports, '__esModule', {
  value: true
});
...
// Cross Browser Animation Transtion
...
},{}]},{},[159,160,161,162,163,164,166,167,168,157,158,165])


//# sourceMappingURL=turnstyle.min.js.map
